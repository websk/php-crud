            ...
            <script>
                ...
                CRUD.Table = CRUD.Table || function (container_class, url) {
                    ...
                    this.initClickRow = function () {
                        ...
                        this.getTableJqueryObj().find("> tbody > tr").each(function () {
                            ...
                            var link_style = "z-index: 1;position: absolute;top: 0;" +
                                "bottom: 0;left: 0;right: 0;display: block;";
                    ...
                    this.tableRender = function (received_html) {
                        ...
                        this.getTableJqueryObj()
                            .html($box.find('.' + this.container_class)
                                .find(table_class).html());
                        this.getPaginationJqueryObj()
                            .html($box.find('.' + this.container_class)
                                .find(pagination_class).html());
